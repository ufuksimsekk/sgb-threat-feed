...
```
[https://raw.githubusercontent.com/OWNER/REPOSITORY/main/feeds/ip.txt](https://raw.githubusercontent.com/ufuksimsekk/sgb-threat-feed/main/feeds/ip.txt)
```
...
config system external-resource
    edit "SGB-Threat-IPs"
        set type address
        set resource ["https://raw.githubusercontent.com/OWNER/REPOSITORY/main/feeds/ip.txt](https://raw.githubusercontent.com/ufuksimsekk/sgb-threat-feed/main/feeds/ip.txt)"
        set refresh-rate 60
        set status enable
